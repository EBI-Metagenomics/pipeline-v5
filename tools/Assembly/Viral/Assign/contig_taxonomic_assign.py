...
def contig_tax(annot_df, min_prot, prop_annot, tax_thres):
	'''This function takes the annotation table generated by viral_contig_maps.py and generates a table that
	   provides the taxonomic lineage of each _viral contig, based on the corresponding ViPhOG annotations'''
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description = "Generate tabular file with taxonomic assignment of _viral contigs based on ViPhOG annotations")
