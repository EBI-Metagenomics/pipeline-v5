...
<<<<<<< HEAD:tools/Assembly/antismash/old_run_antismash/run_antismash.sh
        ../post-processing/json_generation/antismash_json_generation -o geneclusters.json -i ${OUTFOLDER}/geneclusters.js

        echo "run reformat clusters"
        ../post-processing/reformat_antismash/reformat-antismash.py -g ${GLOSSARY} -a ${OUTFOLDER}/geneclusters.txt
=======
...
>>>>>>> add dockers to pipeline:tools/Assembly/antismash/old_run_antismash/run_antismash.sh
