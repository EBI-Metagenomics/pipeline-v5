...
export OUT_DIR_FINAL=${OUT_DIR}/${NAME_RUN}
echo "move first part"
mkdir -p ${OUT_DIR_FINAL} && rm -rf ${OUT_DIR_FINAL}/*
mv ${OUT_TOOL_1}/* ${OUT_DIR_FINAL} && rm -rf ${OUT_TOOL_1}
if [ -d ${OUT_TOOL_2} ]
then
    echo "move second part"
    mv ${OUT_TOOL_2}/* ${OUT_DIR_FINAL} && rm -rf ${OUT_TOOL_2}
fi
