...
source /hps/nobackup2/production/metagenomics/pipeline/testing/kate/toil-lsf/bin/activate
#/hps/nobackup2/production/metagenomics/pipeline/tools-v5/toil-user-env/bin/activate
...
export NAME_RUN=queues
export CWL=/hps/nobackup2/production/metagenomics/pipeline/tools-v5/kate_test/pipeline-v5/workflows/queue.cwl
export YML=/hps/nobackup2/production/metagenomics/pipeline/tools-v5/kate_test/pipeline-v5/workflows/queue.yml
